(() => {
  ...
  var DisclaimerModal = ({ onAcknowledge }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "disclaimer-overlay", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "disclaimer-modal", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: "Important Notice" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [
      "This is an ",
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "unofficial tool" }),
      " developed for use by the 114th Signal Company. It does not reflect the official views or endorsements of the U.S. Army, the Department of Defense (DoD), or the U.S. Government."
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { className: "warning", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "DO NOT" }),
      " enter any Classified, Controlled Unclassified Information (CUI), or Personally Identifiable Information (PII) into this application."
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: 'By clicking "Acknowledge," you confirm that you have read and understood this notice.' }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: onAcknowledge, className: "acknowledge-btn", children: "Acknowledge" })
  ] }) });
  var App = () => {
    ...
    const [showDisclaimer, setShowDisclaimer] = (0, import_react.useState)(false);
    const [showPrintRangeModal, setShowPrintRangeModal] = (0, import_react.useState)(false);
    const [printStartDate, setPrintStartDate] = (0, import_react.useState)("");
    const [printEndDate, setPrintEndDate] = (0, import_react.useState)("");
    const [showExportModal, setShowExportModal] = (0, import_react.useState)(false);
    const [exportStartDate, setExportStartDate] = (0, import_react.useState)("");
    const [exportEndDate, setExportEndDate] = (0, import_react.useState)("");
    ...
    const [fiscalYear, setFiscalYear] = (0, import_react.useState)((/* @__PURE__ */ new Date()).getFullYear() + ((/* @__PURE__ */ new Date()).getMonth() >= 9 ? 1 : 0));
    const [showCreateEventModal, setShowCreateEventModal] = (0, import_react.useState)(false);
    const [newEventData, setNewEventData] = (0, import_react.useState)({
    ...
    const [selectedSquads, setSelectedSquads] = (0, import_react.useState)([]);
    const squads = [
      { name: "Squad 1", id: 1 },
      { name: "Squad 2", id: 2 },
      { name: "Squad 3", id: 3 },
    ...
    const [lastEdited, setLastEdited] = (0, import_react.useState)(() => {
      try {
    ...
    const [editingEventData, setEditingEventData] = (0, import_react.useState)({});
    const today = (0, import_react.useMemo)(() => {
      const d = /* @__PURE__ */ new Date();
      d.setHours(0, 0, 0, 0);
      return d;
    }, []);
    const startOfWeek = (0, import_react.useMemo)(() => {
    ...
    const endOfWeek = (0, import_react.useMemo)(() => {
    ...
    const handleSave = () => {
      try {
        const newTimestamp = /* @__PURE__ */ new Date();
    ...
    const getFiscalYearInfo = (year) => {
      const fiscalYearStartDate = new Date(year - 1, 9, 1);
      let firstWeekStartDate = new Date(fiscalYearStartDate);
      firstWeekStartDate.setHours(0, 0, 0, 0);
      while (firstWeekStartDate.getDay() !== 1) {
    ...
    const handleStatusChange = (date, squadId, eventId, newStatus) => {
    ...
    const handleEditSave = (date, squadId, eventId) => {
      const dateKey = getDateKey(date);
      setCalendar((prev) => {
        if (!prev[dateKey])
          return prev;
        const updatedCalendar = { ...prev };
        const updatedDay = { ...updatedCalendar[dateKey] };
        const updatedSquadEvents = updatedDay[squadId].map((ev) => ev.id === eventId ? { ...editingEventData } : ev);
        updatedDay[squadId] = updatedSquadEvents;
        updatedCalendar[dateKey] = updatedDay;
        return updatedCalendar;
      });
    ...
    const handleSquadSelection = (squadId) => {
      setSelectedSquads(
        (prev) => prev.includes(squadId) ? prev.filter((id) => id !== squadId) : [...prev, squadId]
      );
    };
    const handleSelectAllSquads = (e) => {
      if (e.target.checked) {
    ...
    const printableEvents = (0, import_react.useMemo)(() => {
      if (!printStartDate || !printEndDate)
        return [];
      const events = [];
      ...
      for (const dateKey of sortedDateKeys) {
        ...
        if (daySchedule) {
          ...
          if (eventsForDay.length > 0) {
            events.push({ date, squadEvents: eventsForDay });
          }
        }
      }
      return events;
    ...
    const renderCalendarView = () => {
      if (viewMode === "year") {
        return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "year-view", children: monthNames.map((month, monthIndex) => {
          const monthDate = new Date(currentDate.getFullYear(), monthIndex, 1);
          const days = generateMonthDays(monthDate);
          return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "year-month-grid", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { className: "year-month-title", children: month }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "year-day-header", children: dayNames.map((d) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: d.charAt(0) }, d)) }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "year-month-days", children: days.map((day) => {
              ...
              return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: `year-day ${isTodayClass} ${isCurrentMonthClass} ${hasEvents ? "has-events" : ""}` }, dateKey);
            }) })
          ] }, month);
        }) });
      }
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "calendar", role: "grid", "aria-label": "Training Calendar", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "calendar-header-row", children: dayNames.map((day) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "calendar-header-cell", children: day }, day)) }),
        calendarDays.map((date, index) => {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: `day-cell ${!isCurrentMonth && viewMode === "month" ? "not-current-month" : ""} ${isAltWeek ? "week-alt-bg" : ""} ${isCurrentWeek && viewMode !== "week" ? "current-week" : ""}`, role: "gridcell", "aria-label": date.toDateString(), children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "day-header", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "day-name", children: dayName }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: `day-number ${isToday ? "today" : ""}`, children: date.getDate() })
            ] }),
            squads.map((squad) => {
              return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: `squad-section squad-${squad.id}`, "aria-label": `Training for ${squad.name} on ${date.toDateString()}`, children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { className: "squad-title", children: squad.name }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", { className: "event-list", "aria-live": "polite", children: daySchedule?.[squad.id]?.map((ev) => {
                  ...
                  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { className: `event-item status-${ev.status.toLowerCase()} ${!isVisible ? "event-hidden" : ""}`, children: editingEventId === ev.id ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "edit-event-form", children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "form-group", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { type: "text", readOnly: true, className: "form-control", value: editingEventData.activity, onChange: (e) => handleEditInputChange("activity", e.target.value), placeholder: "Activity" }) }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "form-group", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("select", { className: "form-control", value: editingEventData.status, onChange: (e) => handleEditInputChange("status", e.target.value), children: trainingStatuses.map((status) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: status, children: status }, status)) }) }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "form-group", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { type: "text", className: "form-control", value: editingEventData.time, onChange: (e) => handleEditInputChange("time", e.target.value), placeholder: "Time" }) }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "form-group", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { type: "text", className: "form-control", value: editingEventData.shiftLead, onChange: (e) => handleEditInputChange("shiftLead", e.target.value), placeholder: "Shift Lead" }) }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "form-group", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("textarea", { className: "form-control", value: editingEventData.notes, onChange: (e) => handleEditInputChange("notes", e.target.value), placeholder: "Notes / Objectives", rows: 1 }) }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "event-actions", children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { className: "save-btn", onClick: () => handleEditSave(date, squad.id, ev.id), children: "Save" }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { className: "cancel-btn", onClick: handleEditCancel, children: "Cancel" })
                    ] })
                  ] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "event-header", children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { className: "event-name", children: ev.activity }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("select", { className: "event-status-select", value: ev.status, onChange: (e) => handleStatusChange(date, squad.id, ev.id, e.target.value), "aria-label": `Change status for ${ev.activity}`, children: trainingStatuses.map((status) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: status, children: status }, status)) })
                    ] }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "event-details", children: [
                    ...
                    ev.notes && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "event-notes", children: ev.notes }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "event-actions", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => handleEditStart(ev), className: "edit-event-btn", "aria-label": `Edit ${ev.activity}`, children: "Edit" }) })
                  ] }) }, ev.id);
                }) })
              ] }, squad.id);
            })
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      showDisclaimer && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DisclaimerModal, { onAcknowledge: handleAcknowledge }),
      showPrintRangeModal && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "disclaimer-overlay", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "print-range-modal", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: "Select Date Range to Print" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "print-range-form", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "form-group", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { htmlFor: "start-date", children: "Start Date" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { id: "start-date", type: "date", className: "form-control", value: printStartDate, onChange: (e) => setPrintStartDate(e.target.value) })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "form-group", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { htmlFor: "end-date", children: "End Date" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { id: "end-date", type: "date", className: "form-control", value: printEndDate, onChange: (e) => setPrintEndDate(e.target.value) })
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "modal-actions", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => setShowPrintRangeModal(false), className: "cancel-btn", children: "Cancel" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: handlePrint, className: "action-btn", children: "Print" })
        ] })
      ] }) }),
      showGenerateModal && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "disclaimer-overlay", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "generate-modal", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: "Generate METL Schedule" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "generate-form", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "form-group", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { htmlFor: "fiscal-year", children: "Fiscal Year (e.g., 2025 for FY25)" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { id: "fiscal-year", type: "number", className: "form-control", value: fiscalYear, onChange: (e) => setFiscalYear(Number(e.target.value)) })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { className: "modal-warning", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Warning:" }),
            " This will remove all events within the selected fiscal year (Oct 1 - Sep 30) and replace them with the standard METL schedule. This action cannot be undone."
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "modal-actions", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => setShowGenerateModal(false), className: "cancel-btn", children: "Cancel" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: handleGenerateSchedule, className: "action-btn", children: "Generate" })
        ] })
      ] }) }),
      showExportModal && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "disclaimer-overlay", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "export-modal", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: "Export Calendar Data" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "export-form", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "form-group", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { htmlFor: "export-start-date", children: "Start Date" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { id: "export-start-date", type: "date", className: "form-control", value: exportStartDate, onChange: (e) => setExportStartDate(e.target.value) })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "form-group", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { htmlFor: "export-end-date", children: "End Date" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { id: "export-end-date", type: "date", className: "form-control", value: exportEndDate, onChange: (e) => setExportEndDate(e.target.value) })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "form-group", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { children: "Format" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "format-selector", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { className: `format-btn ${exportFormat === "json" ? "active" : ""}`, onClick: () => setExportFormat("json"), "aria-pressed": exportFormat === "json", children: "JSON" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { className: `format-btn ${exportFormat === "csv" ? "active" : ""}`, onClick: () => setExportFormat("csv"), "aria-pressed": exportFormat === "csv", children: "CSV" })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "modal-actions", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => setShowExportModal(false), className: "cancel-btn", children: "Cancel" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: handleExportData, className: "action-btn", children: "Download" })
        ] })
      ] }) }),
      showCreateEventModal && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "disclaimer-overlay", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "create-modal", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: "Create Custom Event" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "create-form", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "form-group", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { htmlFor: "event-date", children: "Date" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { id: "event-date", type: "date", className: "form-control", value: newEventData.date, onChange: (e) => handleNewEventInputChange("date", e.target.value) })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "form-group", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { htmlFor: "event-activity", children: "Activity" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { id: "event-activity", type: "text", className: "form-control", value: newEventData.activity, onChange: (e) => handleNewEventInputChange("activity", e.target.value), placeholder: "e.g., Weapons Cleaning" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "form-group", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { htmlFor: "event-squads", children: "Squads" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "squad-selector-group", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "squad-selector-item", children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { type: "checkbox", id: "all-squads", onChange: handleSelectAllSquads, checked: selectedSquads.length === squads.length }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { htmlFor: "all-squads", children: "All Squads" })
              ] }),
              squads.map((squad) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "squad-selector-item", children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { type: "checkbox", id: `squad-${squad.id}`, checked: selectedSquads.includes(squad.id), onChange: () => handleSquadSelection(squad.id) }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { htmlFor: `squad-${squad.id}`, children: squad.name })
              ] }, squad.id))
            ] })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "form-group", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { htmlFor: "event-time", children: "Time" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { id: "event-time", type: "text", className: "form-control", value: newEventData.time, onChange: (e) => handleNewEventInputChange("time", e.target.value) })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "form-group", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { htmlFor: "event-lead", children: "Shift Lead" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { id: "event-lead", type: "text", className: "form-control", value: newEventData.shiftLead, onChange: (e) => handleNewEventInputChange("shiftLead", e.target.value) })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "form-group", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { htmlFor: "event-notes", children: "Notes" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("textarea", { id: "event-notes", className: "form-control", value: newEventData.notes, onChange: (e) => handleNewEventInputChange("notes", e.target.value) })
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "modal-actions", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: handleCloseCreateModal, className: "cancel-btn", children: "Cancel" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: handleCreateEvent, className: "action-btn", children: "Add Event" })
        ] })
      ] }) }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "classification-banner top-banner", children: "UNCLASSIFIED" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { children: "Training Calendar" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "last-edited-timestamp", children: lastEdited ? `Last Saved: ${lastEdited.toLocaleString()}` : "No changes saved yet." }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "calendar-controls", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { type: "search", value: searchQuery, onChange: (e) => setSearchQuery(e.target.value), placeholder: "Search events...", className: "search-input", "aria-label": "Search training events" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "navigation-controls", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => handleNavigation("prev"), className: "nav-btn", children: "\xAB Prev" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => handleNavigation("today"), className: "nav-btn today-btn", children: "Today" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => handleNavigation("next"), className: "nav-btn", children: "Next \xBB" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { className: "current-date-display", children: renderCurrentDateHeader() }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "view-switcher", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => setViewMode("year"), className: `view-btn ${viewMode === "year" ? "active" : ""}`, children: "Year" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => setViewMode("month"), className: `view-btn ${viewMode === "month" ? "active" : ""}`, children: "Month" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => setViewMode("week"), className: `view-btn ${viewMode === "week" ? "active" : ""}`, children: "Week" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "main-actions", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: handleSave, className: "action-btn", children: "Save Calendar" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => setShowCreateEventModal(true), className: "action-btn", children: "Create Event" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => setShowGenerateModal(true), className: "action-btn", children: "Generate METL Schedule" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: handleOpenPrintModal, className: "action-btn", children: "Print Calendar" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: handleOpenExportModal, className: "action-btn", children: "Export Calendar" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("main", { children: renderCalendarView() }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "classification-banner bottom-banner", children: "UNCLASSIFIED" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "print-view", "aria-hidden": "true", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "print-header", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h1", { children: [
          "Training Calendar - ",
          printStartDate,
          " to ",
          printEndDate
        ] }) }),
        printableEvents.length > 0 ? printableEvents.map(({ date, squadEvents }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "print-day", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: date.toLocaleDateString("en-US", { weekday: "long", year: "numeric", month: "long", day: "numeric" }) }),
          squadEvents.map(({ squadName, events }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "print-squad", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", { children: squadName }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", { className: "print-table", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "Activity" }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "Time" }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "Shift Lead" }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "Status" }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "Notes" })
              ] }) }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: events.map((ev) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: ev.activity }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: ev.time || "N/A" }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: ev.shiftLead || "N/A" }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: ev.status }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: ev.notes || "N/A" })
              ] }, ev.id)) })
            ] })
          ] }, squadName))
        ] }, getDateKey(date))) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "No events scheduled for the selected date range." })
      ] })
    ] });
  };
